		...
		extend: {
			...
			keyframes: {
				...
				'plane-fly': {
					...
					'100%': { transform: 'translate(var(--fly-x), var(--fly-y)) rotate(var(--fly-rotation))', opacity: '1' }
				},
				'fade-in': {
			...
			animation: {
				...
				'card-pop': 'card-pop 0.5s cubic-bezier(0.68, -0.55, 0.265, 1.55)'
			}
		}
	},
